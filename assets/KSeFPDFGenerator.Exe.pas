...
procedure GenPDF(const aXML: TStream; ANrKSeF: string; const aXMLType: TXMLType; const aEnvironment: TEnvironment; const aOutStream: TStream; const aOptions: TGenOptions);
